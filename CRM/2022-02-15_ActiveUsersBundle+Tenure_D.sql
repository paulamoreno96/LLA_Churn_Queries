...
PLANACTIVOS AS(
    ...
    CASE WHEN C_CUST_AGE <= 6 THEN "<6M"
        WHEN C_CUST_AGE > 6 AND C_CUST_AGE <= 12 THEN "06-1Y"
        WHEN C_CUST_AGE > 12 AND C_CUST_AGE <= 24 THEN "1Y-2Y"
        WHEN C_CUST_AGE > 24 THEN ">2Y"
        END AS TENURE
    ...
    GROUP BY ACT_ACCT_CD, PFLAG, MESPLAN, TENURE, FECHAACTIVO
