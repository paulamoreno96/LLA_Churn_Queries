...
CRUCEPLANCHURN AS
(
 SELECT DISTINCT c.ACT_ACCT_CD,c.maxFechaC, p.Pflag, C_CUST_AGE
 ...
 GROUP BY c.ACT_ACCT_CD, c.MaxfechaC, p.PFLAG, C_CUST_AGE
),
TENURECHURN AS(
    ...
    WHEN Max(C_CUST_AGE) >24  THEN ">2Y" END AS TENURE,
    FROM CRUCEPLANCHURN c
    GROUP BY ACT_ACCT_CD, PFLAG, c.maxFechaC
)
