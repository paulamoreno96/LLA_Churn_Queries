...
SELECT MG.MES_ASIGNACION 
 , MG.BUCKET_MORA 
    , COUNT(DISTINCT CASE WHEN GI.Promesa = "SI" AND MG.PAGO_ANTES THEN MG.CONTRATO_ID END) AS CONTRATOS_PAGO
    , COUNT(DISTINCT CASE WHEN GI.Promesa = "SI" THEN MG.CONTRATO_ID END) AS CONTRATOS_PROMESA
    , ROUND(
        COUNT(DISTINCT CASE WHEN GI.Promesa = "SI" AND MG.PAGO_ANTES THEN MG.CONTRATO_ID END) 
        / NULLIF(
