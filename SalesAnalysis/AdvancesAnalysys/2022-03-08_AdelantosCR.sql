...
COUNT(DISTINCT NOCHURNERS) AS NC, COUNT(DISTINCT CHURNERS) AS C, COUNT (DISTINCT NOCHURNERS_SIN_ADELANTO) AS NC_SIN_ADELANTO, COUNT (DISTINCT NOCHURNERS_ADELANTO_5000) AS NC_5000, COUNT (DISTINCT NOCHURNERS_ADELANTO_10000) AS NC_10000, COUNT (DISTINCT CHURNERS_SIN_ADELANTO) AS C_SIN_ADELANTO, COUNT (DISTINCT CHURNERS_ADELANTO_5000) AS C_5000, COUNT(DISTINCT CHURNERS_ADELANTO_10000) AS C_10000
FROM CRUCEFINAL
GROUP BY MESALTA
ORDER BY MESALTA
